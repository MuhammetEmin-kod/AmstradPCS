...
{
    public partial class AmsGxP : Form
    {
        public AmsGxP()
        {
            InitializeComponent();
        ...
        private void AmsGxP_Load(object sender, EventArgs e)
        {
            ...
            //mc.messagelist().lengt deseydım butun mesajların uzunluğunu alıcaktım
            //bunun yerine fazla yer kaplamaması adına category idsi 4 olan messajların uzunlugunu aldım
